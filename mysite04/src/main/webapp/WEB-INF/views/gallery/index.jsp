...
<body>
	<div id="container">
		...
		<div id="content">
			<div id="gallery">
				<div>
					<h1 style=" background: url('${pageContext.request.contextPath }/assets/images/gallery.png') no-repeat / 35px">갤러리</h1>
					...
					<c:forEach items="${list}" var="vo">
						<li>
							...
							<a	href="${pageContext.request.contextPath }/gallery/delete/${vo.no}"
								class="del-button" style="background: url('${pageContext.request.contextPath }/assets/images/delete-image.png') no-repeat 0 0 / 18px"
								title="삭제">삭제</a>
						</li>
					</c:forEach>																																	
				</ul>	
